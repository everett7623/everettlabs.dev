...
### 2026-07-24 Ko-fi 产品决定

- 用户明确新增官方 Ko-fi 页面 `https://ko-fi.com/everettlabs`，此前“只接受加密货币”的决定由本次要求更新。
- Ko-fi 作为独立外链方式展示，不替换或修改四组 Binance 公开充值地址、网络校验、二维码与区块浏览器入口。
- 不接入 Ko-fi 脚本、iframe、远程图片、Cookie 或新分析事件；实现与验证记录见 `.codex/tasks/coffee-kofi-2026-07-24.md`。
